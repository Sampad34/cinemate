    ...
    <main className="px-4 sm:px-6 lg:px-12 py-8">
      <section className="flex flex-col lg:flex-row gap-8 lg:gap-16">
        ...
        <div className="flex-shrink-0 mx-auto lg:mx-0">
          <img
            className="rounded-xl shadow-lg max-w-xs sm:max-w-sm md:max-w-md"
            src={image}
            alt={movie.title}
          />
        </div>
        ...
        {/* Movie Info */}
        <div className="max-w-3xl text-gray-700 dark:text-gray-200">
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-4 text-center lg:text-left">
            {movie.title}
          </h1>
          ...
          {movie.genres ? (
            <div className="flex flex-wrap gap-2 mb-6">
              {movie.genres.map((genre) => (
                <span
                  className="px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-full text-sm sm:text-base bg-gray-100 dark:bg-gray-700"
                  key={genre.id}
                >
                  {genre.name}
                </span>
          ...
          <div className="space-y-3 text-sm sm:text-base md:text-lg">
            <p>
              <span className="font-bold">Runtime:</span> {movie.runtime} mins
            </p>
            <p>
